...
public class GlobalExceptionHandler {
    ...
    /**
     * Extracts field validation errors from the exception.
     * 
    ...
    /**
     * Creates a ValidationErrorResponse with the provided validation errors.
     * 
     * @param errors the map of field validation errors
